...
public class StudentDegreeEntityRepository {
    ...
    public StudentDegreeEntityRepository(StudentDegreeMapper studentDegreeMapper, CrudStudentDegreeRepository crudStudentDegreeRepository, CrudStudentRepository crudStudentRepository, CrudDegreeRepository crudDegreeRepository) {
    ...
    public StudentDegreeResponseDto add(String username, StudentDegreeRequestDto studentDegreeRequestDto) {
        ...
        DegreeEntity degree = this.crudDegreeRepository.findByIdDegree(studentDegreeRequestDto.idDegree());

        //adding id student
        studentDegreeEntity.setStudent(studentEntity);
        //adding id Degree
        studentDegreeEntity.setDegree(degree);
